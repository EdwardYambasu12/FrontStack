...
(function($, window, document, undefined) {
    ...
    var leagues_ids =  [347, 207,152, 175,207, 300, 146, 332, 278, 28, 3, 4, 377, 683, 1, 17, 302, 168]
    ...
    $.extend(Plugin.prototype, {
        ...
        initialContent: function(countriesAjaxURL, action, Widgetkey, preferentialCountries, preferentialLeagues) {
            ...
            var headerMenuDisplay = '<nav class = "nav fixed-top" id="page-nav">';
            // Here you can change your "Home Page"
            headerMenuDisplay += '<div class = "main_navbar">'
            headerMenuDisplay +=  '<div id = "flex"> <img id = "this_picture" alt = "min_pic2" src = "main_logo.png"><h1>SportUp</h1></div>'

   
            headerMenuDisplay += '<a href="search.html"><h4>🔎</h4></a>';
            headerMenuDisplay += '</div>';
            headerMenuDisplay += '<div class = "bg-light" id = "texture">';
            ...
            headerMenuDisplay += `<h1 class = "finding_height"><a href = "new.html">NEWS</a></h1>`
            ...
            //setting calendar button to popup when user click it
            ...
            $('#callendar-select-for-mobile').on('change', function() {
                ...
                $.ajax({
                    ...
                    dataType: 'json'
                        ...
                        console.log(res, "gottten")
                        var important = []


                        leagues_ids.forEach((element)=>{
                            filter = res.filter((item)=> item.league_id== element)
                            console.log(filter)
                            filter.map((item)=>{
                                 important.push(item)
                            })
                  ...
                  $.ajax({
                    ...
                    $('.loading').hide();
                    // Construct the section for All Games in that specific day
                    $('#allGame').append('<section id="allGameContentTable2"></section>');
                    ...
                    if (!res.error) {
                        ...
                        htmlConstructor += '</div>';
                        $('#allGameContentTable2').append(htmlConstructor);
