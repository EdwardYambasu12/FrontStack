                    ...
                    var seeWhatMatchDetailsToShow = setInterval(function() {
                        if (timeForFixtures.length > 0) {
                            ...
                            if ((sessionStorage.getItem('fixturesDate') > timeForFixtures) || ((res[0].match_status == null) || (res[0].match_status === ''))) {
                                ...
                                htmlConstructor += '</div>';
                                htmlConstructor += '<div>' + res[0].country_name + ': ' + res[0].league_name + '</div>'
                                ...
                                if ((res[0].lineup.home.starting_lineups.length == 0) || (res[0].lineup.away.starting_lineups.length == 0)) {
                                    ...
                                    $.each(res[0].lineup.away.starting_lineups, function(key, value) {
                                        htmlConstructor += '<div class="lineupsContainerAway"><div onclick = "pointer()" class="lineupsPlayer">' + value.lineup_player + '</div> <div class="lineupsFlag" style="background-image: url(\'' + res[0].team_away_badge + '\');"></div> <div class="lineupsNb">' + ((value.lineup_number == '-1' ? ' ' : value.lineup_number)) + '</div></div>';
                                    });
                                    htmlConstructor += '</div>';
                                }
                                htmlConstructor += '</div>';
